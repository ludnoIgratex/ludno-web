  ...
  return (function (e) {
          ...
          for (var s = [], l = 0; l < e.length; l++) {
            ...
            if (0 !== p) {
              ...
              -1 === n && (h = 1.75 * Math.pow(p, 0.32)),
                (h = r.clamp(h, i, a)),
                h % 2 == 1 && (h += 1);
              for (var b = Math.acos(o.dot(f, v)), S = b / h, w = 0; w < h; w++)
                s.push(o.add(o.rotate(m, S * w), x));
            } else s.push(u);
          }
          return s;
        }),
        ...
        (i.isConvex = function (e) {
          ...
          for (t = 0; t < a; t++)
            if (
              ((n = (t + 1) % a),
              (i = (t + 2) % a),
              (o = (e[n].x - e[t].x) * (e[i].y - e[n].y)),
              (o -= (e[n].y - e[t].y) * (e[i].x - e[n].x)),
              o < 0 ? (r |= 1) : o > 0 && (r |= 2),
              3 === r)
            )
              return !1;
    ...
    function (e, t, n) {
      ...
      (function () {
        ...
        (i.set = function (e, t, n) {
          var o;
          for (o in ("string" == typeof t && ((o = t), (t = {}), (t[o] = n)),
          t))
          ...
          (i.update = function (e, t) {
            t = (void 0 !== t ? t : 1e3 / 60) * e.timeScale;
            var n = t * t,
        ...
        (i.trigger = function (e, t, n) {
          ...
          if (l && o.keys(l).length > 0) {
            ...
            for (var c = 0; c < i.length; c++)
              if (((r = i[c]), (a = l[r]), a)) {
                (s = o.clone(n, !1)), (s.name = r), (s.source = e);
        ...
        (i._overlapAxes = function (e, t, n, i) {
          ...
          for (l = 0; l < m; l++) {
            var h = i[l],
              ...
              C = A;
            for (c = 1; c < u; c += 1)
              (s = t[c].x * b + t[c].y * S), s > P ? (P = s) : s < w && (w = s);
            for (c = 1; c < d; c += 1)
              (s = n[c].x * b + n[c].y * S), s > C ? (C = s) : s < A && (A = s);
            if (
              ((r = P - A),
              (a = C - w),
              (o = r < a ? r : a),
          ...
          if (n || o) {
            ...
            if (
              ...
              var p,
                ...
                m,
                g = (d - e.length) / d,
                x = e.stiffness >= 1 || 0 === e.length,
                h = x ? e.stiffness * t : e.stiffness * t * t,
                b = e.damping * t,
                S = r.mult(u, g * h),
                w = (n ? n.inverseMass : 0) + (o ? o.inverseMass : 0),
                A = (n ? n.inverseInertia : 0) + (o ? o.inverseInertia : 0),
                P = w + A;
              if (b > 0) {
                var C = r.create();
                (v = r.div(u, d)),
                  (m = r.sub(
                    (o && r.sub(o.position, o.positionPrev)) || C,
              ...
              n &&
                !n.isStatic &&
                ((f = n.inverseMass / w),
                (n.constraintImpulse.x -= S.x * f),
                (n.constraintImpulse.y -= S.y * f),
                (n.position.x -= S.x * f),
                (n.position.y -= S.y * f),
                b > 0 &&
                  ((n.positionPrev.x -= b * v.x * y * f),
                  (n.positionPrev.y -= b * v.y * y * f)),
                (p =
                  (r.cross(a, S) / P) *
                  i._torqueDampen *
                  n.inverseInertia *
                ...
                o &&
                  !o.isStatic &&
                  ((f = o.inverseMass / w),
                  (o.constraintImpulse.x += S.x * f),
                  (o.constraintImpulse.y += S.y * f),
                  (o.position.x += S.x * f),
                  (o.position.y += S.y * f),
                  b > 0 &&
                    ((o.positionPrev.x += b * v.x * y * f),
                    (o.positionPrev.y += b * v.y * y * f)),
                  (p =
                    (r.cross(s, S) / P) *
                    i._torqueDampen *
                    o.inverseInertia *
        ...
        (i.fromVertices = function (e, t, n, i, c, u, d, p) {
          ...
          for (
            ...
            if (
              ...
              (x = m ? o.clockwiseSort(x) : o.hull(x)),
                y.push({ position: { x: e, y: t }, vertices: x });
            else {
              var C = x.map(function (e) {
                return [e.x, e.y];
              });
              P.makeCCW(C),
                !1 !== u && P.removeCollinearPoints(C, u),
                !1 !== p &&
                  P.removeDuplicatePoints &&
                  P.removeDuplicatePoints(C, p);
              var M = P.quickDecomp(C);
              for (h = 0; h < M.length; h++) {
                ...
                (d > 0 && o.area(_) < d) ||
                  y.push({ position: o.centre(_), vertices: _ });
              }
            }
          for (h = 0; h < y.length; h++) y[h] = a.create(r.extend(y[h], i));
          if (c) {
            var k = 5;
            for (h = 0; h < y.length; h++) {
              ...
              for (b = h + 1; b < y.length; b++) {
                var T = y[b];
                if (s.overlaps(I.bounds, T.bounds)) {
                  var R = I.vertices,
                    V = T.vertices;
                  for (S = 0; S < I.vertices.length; S++)
                    for (A = 0; A < T.vertices.length; A++) {
                      var E = l.magnitudeSquared(
                          l.sub(R[(S + 1) % R.length], V[A])
                        ),
                        L = l.magnitudeSquared(
                          l.sub(R[S], V[(A + 1) % V.length])
                        );
                      E < k &&
                        L < k &&
                        ((R[S].isInternal = !0), (V[A].isInternal = !0));
                    }
                }
              }
            }
              ...
              if (
                ...
                if (x && 1 === S) {
                  ...
                  for (
                    ...
                    for (
                      var M = d.parts[C], B = ((p = M.bounds), P);
                      B < S;
                      B++
                    ) {
                      var _ = h.parts[B];
      ...
      (i.create = function (e) {
        ...
        return (
          ...
          (t.mousedown = function (e) {
            var n = i._getRelativeMousePosition(e, t.element, t.pixelRatio),
              o = e.changedTouches;
            o ? ((t.button = 0), e.preventDefault()) : (t.button = e.button),
              (t.absolute.x = n.x),
              (t.absolute.y = n.y),
              (t.position.x = t.absolute.x * t.scale.x + t.offset.x),
              (t.position.y = t.absolute.y * t.scale.y + t.offset.y),
    ...
    function (e, t, n) {
      ...
      (i.create = function (e) {
        ...
        var t = {
          ...
          n = d.extend(t, e);
        return (
          (n.world = e.world || c.create({ label: "World" })),
          (n.pairs = e.pairs || s.create()),
          (n.detector = e.detector || a.create()),
          (n.grid = { buckets: [] }),
          (n.world.gravity = n.gravity),
          (n.broadphase = n.grid),
          (n.metrics = {}),
          n
        );
      ...
      (i._restingThresh = 2),
        ...
        (i.solveVelocity = function (e, t) {
          var n,
            ...
            c = l * l,
            u = c * l,
            d = -i._restingThresh * l,
            p = i._restingThreshTangent,
            f = i._frictionNormalMultiplier * l,
            v = i._frictionMaxStatic,
            y = e.length;
          for (a = 0; a < y; a++) {
            var m = e[a];
            if (m.isActive && !m.isSensor) {
              var g = m.collision,
                ...
                B = M.length,
                _ = 1 / B,
                k = x.inverseMass + h.inverseMass,
                I = m.friction * m.frictionStatic * f;
              for (
                b.x = x.position.x - x.positionPrev.x,
                  b.y = x.position.y - x.positionPrev.y,
                  S.x = h.position.x - h.positionPrev.x,
                  S.y = h.position.y - h.positionPrev.y,
                ...
                var T = M[s],
                  ...
                  L = R.x - h.position.x,
                  D = R.y - h.position.y,
                  O = b.x - E * x.angularVelocity,
                  F = b.y + V * x.angularVelocity,
                  H = S.x - D * h.angularVelocity,
                  j = S.y + L * h.angularVelocity,
                  q = O - H,
                  W = F - j,
                  G = w * q + A * W,
                  U = P * q + C * W,
                ...
                var Q = V * A - E * w,
                  ...
                  Z =
                    _ /
                    (k + x.inverseInertia * Q * Q + h.inverseInertia * Y * Y),
                  $ = (1 + m.restitution) * G * Z;
                if (((n *= Z), G < d)) T.normalImpulse = 0;
                else {
                  var J = T.normalImpulse;
                  (T.normalImpulse += $),
                    T.normalImpulse > 0 && (T.normalImpulse = 0),
                    ($ = T.normalImpulse - J);
                }
                if (U < -p || U > p) T.tangentImpulse = 0;
                else {
                  var K = T.tangentImpulse;
                  (T.tangentImpulse += n),
                    T.tangentImpulse < -o && (T.tangentImpulse = -o),
                    T.tangentImpulse > o && (T.tangentImpulse = o),
                    (n = T.tangentImpulse - K);
                }
                var ee = w * $ + P * n,
                  te = A * $ + C * n;
                x.isStatic ||
                  x.isSleeping ||
                  ((x.positionPrev.x += ee * x.inverseMass),
                  (x.positionPrev.y += te * x.inverseMass),
                  (x.anglePrev += (V * te - E * ee) * x.inverseInertia)),
                  h.isStatic ||
                    h.isSleeping ||
                    ((h.positionPrev.x -= ee * h.inverseMass),
                    (h.positionPrev.y -= te * h.inverseMass),
                    (h.anglePrev -= (L * te - D * ee) * h.inverseInertia));
              }
            }
          }
        });
      ...
      (i.create = function (e) {
        ...
        (i.update = function (e, t, n) {
            ...
            (i = t[s]),
              ...
              a
                ? (a.isActive ? v.push(a) : p.push(a),
                  o.update(a, i, n),
                  (a.confirmedActive = !0))
                : ((a = o.create(i, n)), (u[a.id] = a), p.push(a), l.push(a));
          var y = [];
          ...
          for (s = 0; s < y.length; s++)
            (r = y[s] - s), (a = l[r]), l.splice(r, 1), delete u[a.id];
        }),
        (i.clear = function (e) {
          return (
            (e.table = {}),
      ...
      (i.stack = function (e, t, n, i, r, a, l) {
        ...
        (i.newtonsCradle = function (e, t, n, i, a) {
          for (
            ...
            var u = 1.9,
              ...
              p = r.create({ pointA: { x: e + c * (i * u), y: t }, bodyB: d });
            o.addBody(s, d), o.addConstraint(s, p);
          }
          return s;
        }),
        c(
        ...
        (i.car = function (e, t, n, i, a) {
          var c = s.nextGroup(!0),
            ...
            p = 0.5 * n - u,
            f = 0,
            v = o.create({ label: "Car" }),
            y = l.rectangle(e, t, n, i, {
              collisionFilter: { group: c },
              chamfer: { radius: 0.5 * i },
              density: 2e-4,
            }),
            m = l.circle(e + d, t + f, a, {
              collisionFilter: { group: c },
              friction: 0.8,
            }),
            g = l.circle(e + p, t + f, a, {
              collisionFilter: { group: c },
              friction: 0.8,
            }),
            x = r.create({
      ...
      (i.create = function (e) {
        ...
        (i._createActivePairsList = function (e) {
          var t,
            ...
            s = [];
          for (n = 0; n < a; n++)
            (t = i[o[n]]), t[2] > 0 ? s.push(t) : delete i[o[n]];
          return s;
        });
    },
    function (e, t, n) {
        ...
        "undefined" != typeof window &&
          ...
          (i.lookAt = function (e, t, n, i) {
            ...
            m > y ? (x = m / y) : (g = y / m),
              ...
              (e.bounds.max.x = o.min.x + d * g),
              (e.bounds.min.y = o.min.y),
              (e.bounds.max.y = o.min.y + p * x),
              i &&
          ...
          (i.world = function (e, t) {
            var n,
              ...
              d = e.engine,
              p = d.world,
              f = (e.canvas, e.context),
              v = e.options,
              m = e.timing,
              g = a.allBodies(p),
              x = a.allConstraints(p),
              h = v.wireframes ? v.wireframeBackground : v.background,
              b = [],
              S = [],
              w = { timestamp: d.timing.timestamp };
            if (
              (l.trigger(e, "beforeRender", w),
              e.currentBackground !== h && y(e, h),
              (f.globalCompositeOperation = "source-over"),
              (f.fillStyle = "#ffffff"),
              f.fillRect(0, 0, v.width, v.height),
              (f.fillStyle = v.intermediateBackgroundColor),
              f.fillRect(30, 30, v.width - 60, v.height - 60),
              (f.globalCompositeOperation = "source-over"),
              f.drawImage(
                v.backgroundImage,
                0,
              ...
              for (n = 0; n < g.length; n++) {
                var A = g[n];
                s.overlaps(A.bounds, e.bounds) && b.push(A);
              }
              for (n = 0; n < x.length; n++) {
                var P = x[n],
                  ...
                  B = P.pointA,
                  _ = P.pointB;
                C && (B = c.add(C.position, P.pointA)),
                  M && (_ = c.add(M.position, P.pointB)),
                  B &&
                    _ &&
                    (s.contains(e.bounds, B) || s.contains(e.bounds, _)) &&
                    S.push(P);
              }
            ...
            !v.wireframes || (d.enableSleeping && v.showSleeping)
              ? i.bodies(e, b, f)
              : (v.showConvexHulls && i.bodyConvexHulls(e, b, f),
                i.bodyWireframes(e, b, f)),
              v.showBounds && i.bodyBounds(e, b, f),
              (v.showAxes || v.showAngleIndicator) && i.bodyAxes(e, b, f),
              v.showPositions && i.bodyPositions(e, b, f),
              v.showVelocity && i.bodyVelocity(e, b, f),
              v.showIds && i.bodyIds(e, b, f),
              v.showSeparations && i.separations(e, d.pairs.list, f),
              v.showCollisions && i.collisions(e, d.pairs.list, f),
              v.showVertexNumbers && i.vertexNumbers(e, b, f),
              v.showMousePosition && i.mousePosition(e, e.mouse, f),
              i.constraints(S, f),
              v.hasBounds && i.endViewTransform(e),
              l.trigger(e, "afterRender", w),
              (m.lastElapsed = r.now() - o);
          }),
          (i.stats = function (e, t, n) {
            ...
            for (var v in ((t.fillStyle = "#0e0f19"),
            t.fillRect(u, d, 5.5 * l, c),
            (t.font = "12px Arial"),
            (t.textBaseline = "top"),
            (t.textAlign = "right"),
            f)) {
              var y = f[v];
              (t.fillStyle = "#aaa"),
                t.fillText(v, u + l, d + 8),
                (t.fillStyle = "#eee"),
                t.fillText(y, u + l, d + 26),
                (u += l);
            }
          }),
          ...
          (i.bodies = function (e, t, n) {
            ...
            for (r = 0; r < t.length; r++)
              if (((i = t[r]), i.render.visible))
                for (a = i.parts.length > 1 ? 1 : 0; a < i.parts.length; a++)
                  if (((o = i.parts[a]), o.render.visible)) {
                    if (
          ...
          (i.bodyConvexHulls = function (e, t, n) {
            ...
            for (a.beginPath(), o = 0; o < t.length; o++)
              if (((i = t[o]), i.render.visible && 1 !== i.parts.length)) {
                for (
          ...
          (i.bodyBounds = function (e, t, n) {
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              if (a.render.visible)
                for (
                  var s = t[r].parts, l = s.length > 1 ? 1 : 0;
                  l < s.length;
                  l++
                ) {
                  var c = s[l];
          ...
          (i.collisions = function (e, t, n) {
            ...
            for (
              ...
              if (
                ((i = t[r]),
                i.isActive && ((o = i.collision), i.activeContacts.length > 0))
              ) {
                ...
                2 === i.activeContacts.length &&
                  ...
                  o.bodyB === o.supports[0].body || !0 === o.bodyA.isStatic
                    ? s.moveTo(d - 8 * o.normal.x, p - 8 * o.normal.y)
                    : s.moveTo(d + 8 * o.normal.x, p + 8 * o.normal.y),
                  s.lineTo(d, p);
              }
            l.wireframes
          ...
          (i.separations = function (e, t, n) {
            ...
            for (l.beginPath(), s = 0; s < t.length; s++)
              if (((i = t[s]), i.isActive)) {
                (o = i.collision), (r = o.bodyA), (a = o.bodyB);
                var u = 1;
          ...
          (i.tick = function (e, t, n) {
            ...
            e.isFixed
              ...
              : ((i = n - e.timePrev || e.delta),
                ...
                (i = i < e.deltaMin ? e.deltaMin : i),
                (i = i > e.deltaMax ? e.deltaMax : i),
                (e.delta = i));
    ...
    function (e, t, n) {
      ...
      (i.collides = function (e, t) {
        ...
        a(i, "collides", "SAT.collides ➤ replaced by Collision.collides");
    },
    function (e, t, n) {
      var i = {};
      e.exports = i;
      ...
      (i.pathToVertices = function (e, t) {
        ...
        var b = function (e, t, n) {
            var i = n % 2 == 1 && n > 1;
            if (!p || e != p.x || t != p.y) {
              p && i ? ((v = p.x), (y = p.y)) : ((v = 0), (y = 0));
              var o = { x: v + e, y: y + t };
              (!i && p) || (p = o), m.push(o), (x = v + e), (h = y + t);
            }
          },
          S = function (e) {
        ...
        for (u = c.concat(); g < a; ) {
          if (((f = e.getPathSegAtLength(g)), (l = c[f]), l != d)) {
            for (; u.length && u[0] != l; ) S(u.shift());
            d = l;
          }
          switch (l.pathSegTypeAsLetter.toUpperCase()) {
            ...
            case "Q":
            case "A":
              (s = e.getPointAtLength(g)), b(s.x, s.y, 0);
          }
          g += t;
        }
        for (n = 0, r = u.length; n < r; ++n) S(u[n]);
        return m;
      }),
