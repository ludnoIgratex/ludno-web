    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.content}>
        <p className={styles.description}>
          Современная игровая площадка может быть интегрирована в городскую
          среду, дополнять окружающий контекст и{" "}
          ...
          парк или элементы геопластики, классики на тротуаре или старое дерево,
          на котором можно посидеть и поиграть в прятки.
        </p>
